    ...
    public class DataManager
    {
        ...
        public void ProductionList(ListView lv, string sYM)
        {
            ...
            try
            {
                ...
                while (oracleDR != null && oracleDR.Read())
                {
                    row = new ListViewItem(oracleDR["pro_code"].ToString());
                    row.SubItems.Add(oracleDR["item"].ToString());
                    row.SubItems.Add(oracleDR["center"].ToString());
                    row.SubItems.Add(cm.ToComma(oracleDR["qty"].ToString()));
                    row.SubItems.Add(oracleDR["sdate"].ToString());
